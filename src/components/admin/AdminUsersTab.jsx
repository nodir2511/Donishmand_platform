...
import {
    ...
    X, Eye, EyeOff, BookOpen, Settings, ChevronLeft, ChevronRight, Trash2, Edit, CheckCircle, AlertCircle
} from 'lucide-react';
import useDebounce from '../../hooks/useDebounce';

// Утилиты для отображения ролей
...
const AdminUsersTab = () => {
    ...
    const lang = 'ru'; // Админка всегда на русском
