...
export const CHANGELOG_HIGHLIGHTS = {
    ...
    date: '19.03.2026',
    changesRu: [
        'Награды за скорость (+1 монета за быстрый ответ)',
        'Накопительный бонус XP за серию быстрых вопросов',
        'Поддержка клавиши Enter в тестах',
        'Улучшенное управление уведомлениями в админке',
        'Исправления багов на экране результатов'
    ],
    changesTj: [
        'Ҷоизаҳо барои суръат (+1 танга барои ҷавоби зуд)',
        'Бонуси ҷамъшавандаи XP барои силсилаи саволҳои зуд',
        'Дастгирии тугмаи Enter дар тестҳо',
        'Идоракунии беҳтаршудаи огоҳиномаҳо дар админка',
        'Ислоҳи хатогиҳо дар экрани натиҷаҳо'
    ]
};
